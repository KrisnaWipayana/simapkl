    ...
    <div class="flex flex-1">
        ...
        <div id="sidebar" class="w-0 bg-white dark:bg-gray-800 shadow-lg transition-all duration-300 overflow-hidden">
            <div class="flex flex-col items-center mt-1">
                <form action="{{ route('logout.dospem') }}" method="POST" id="logoutForm">
                @csrf
                ...
                <a href="{{ route('dashboard.dospem') }}" title="Statistik">
                ...
                <a href="{{ route('dashboard.berkas.mhs') }}" title="Laporan">
                <div class="sidebar-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                ...
                <a href="{{ route('dashboard.profile.mhs') }}" title="Profil">
                <div class="sidebar-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
